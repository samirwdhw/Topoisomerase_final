...
//With a exponentially decreasing Force Profile along the chromosome
...
#define FILE_NAME "timeVsForce_expo.dat"		//To see where to output data
...
/*
				if(runs == 0){
					...
					cout<<"Time: "<<time1<<" Cats: "<<n_cats<<"Prob: "<<prob<<endl;
				}
*/
